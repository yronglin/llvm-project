...
// X86: @[[REFTMP1:[.A-Za-z0-9_$]+]] = internal constant [2 x i32] [i32 42, i32 43], section ".rodata.pnu", align 4
// X86: @[[REFTMP2:[.A-Za-z0-9_$]+]] = internal constant [3 x %{{.*}}] [%{{.*}} { i32 1 }, %{{.*}} { i32 2 }, %{{.*}} { i32 3 }], section ".rodata.pnu", align 4
